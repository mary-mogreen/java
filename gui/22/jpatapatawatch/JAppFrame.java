...
import jpatapatawatch.JPropertiesDialog;
import jpatapatawatch.JWatchProperties;
...
public class JAppFrame extends JFrame implements ActionListener {
	JClockCanvas canvas;
	...
	public JAppFrame(JClockCanvas canvas) {
		super(null, null);
		this.canvas = canvas;
