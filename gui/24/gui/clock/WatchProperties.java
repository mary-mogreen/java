...
public class WatchProperties {
	...
	public void init() {
		color = ColorBuilder.toColor("light gray");
		bgColor = ColorBuilder.toColor("dark gray");
		flipColor = ColorBuilder.toColor("original");
	...
	public void initPref() {
		...
		//font = new Font(Font.SANS_SERIF, Font.BOLD, 120);
		font = Font.decode(prefs.getWatchFont()).deriveFont(Font.PLAIN, prefs.getWatchFontSize());
