...
public class ObjectCreator extends JPanel implements Creator {
	...
	public ObjectCreator(String insName, String clsName) {
		this();
	    ...
	    createBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(ObjectCreator.this, t.toString());
				}
